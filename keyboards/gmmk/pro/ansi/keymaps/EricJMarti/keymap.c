...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______,        _______, _______,                            KC_MPLY,                            _______, _______, MO(5),   _______, _______, _______
    ),
    ...
    [2] = LAYOUT(
        ...
        MO(3),                      _______, _______, RCTL(KC_INS), RSFT(KC_INS), KC_PGUP, _______, _______, _______, _______, _______,          MO(4),   _______, _______,
