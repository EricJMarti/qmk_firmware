...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        _______,        _______, _______,                            KC_MPLY,                            _______, _______, MO(3),   _______, _______, _______
    ),

    [2] = LAYOUT(
        _______,        _______,    _______, _______, _______,      _______,      _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______,        _______,    _______, _______, _______,      _______,      _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______,        LCTL(KC_Q), _______, _______, LCTL(KC_R),   _______,      _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______,        _______,    _______, _______, KC_PGDN,      _______,      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,          _______,          _______,
        MO(3),                      _______, _______, RCTL(KC_INS), RSFT(KC_INS), KC_PGUP, _______, _______, _______, _______, _______,          _______, _______, _______,
